...
def main():
    ...
    parser.add_argument('-m', '--entity_process_map',
                        default='$(find scrimmage_ros)/src/scrimmage_ros/test/templates/entity_types_map.yaml')
    parser.add_argument('-s', '--sim_mission_yaml_file', default=None)
    parser.add_argument('-p', '--processes_yaml_file', default=None)
    ...
    entity_launch = EntityLaunch(args.sim_mission_yaml_file,
                                 ...
                                 args.entity_process_map, logs_path,
                                 run_dir, None, None)
